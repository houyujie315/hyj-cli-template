<template>
  ...
  >
    ...
    <password-modal ref="passwdModal" @ok="handleModelOK"></password-modal>
  </a-list>
</template>
...
export default {
  ...
  computed: {
    data () {
          return [
          { title: this.$t('account.settings.security.password'), description: this.$t('account.settings.security.password-description'), value: '强', actions: { title: this.$t('account.settings.security.modify'), callback: () => { this.$refs.passwdModal.edit() } } },
